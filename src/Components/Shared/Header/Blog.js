      ...
      <div>
        <div style={{ marginTop: "150px" }}>
          ...
          <p>
            ...
            mechanism that allows a server to indicate any origins other than
            its own from which a browser should permit loading resources. CORS
            ...
            check that the server will permit the actual request. In that
            preflight, the browser sends headers that indicate the HTTP method
          ...
          <p>
            ...
            even better together. <h5>Alternatives of firebase:</h5>
